...
int main(int argc, char const *argv[])
{
		...
		for (int i = 0; i < size; i++)
	{
		if(i%3==0)
		{	
			pthread_create(&t[i],NULL,(void*)*Teacher,NULL);
		}
		else if(i%3==1)
		{
			pthread_create(&t[i],NULL,(void*)*Parent,NULL);
		}
		else
		{
			pthread_create(&t[i],NULL,(void*)*Child,NULL);
		}
	}
...
void verify_compliance()
{
	...
	{
		printf("Fetching A Teacher to meet Regulation\n");
		pthread_create(&o,NULL,(void*)*Teacher,NULL);
	}
